...
class InactiveResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            "action" => "
            <button class='btn btn-sm btn-primary info-btn'>
                <i class='fa fa-info'></i>
            </button>
            <button  class='btn btn-sm btn-success student-update-btn'>
                <i class='fa fa-pencil-square-o' aria-hidden='true'></i>
            </button>
            <button class='btn btn-sm btn-danger restore-btn'>Restore</button>
        "
        ];
    }
}
